...
int main(int argc, char* argv[])
{
    ...
    // Window setup
    {
        ...
        window = glfwCreateWindow(1024, 1024, "Cloth Simulation with Mass Spring", NULL, NULL);
        if (!window) {
            glfwTerminate();
            return -1;
        }
    ...
    // Main Loop
    {
        ...
        // Overall settings
        auto vertexShader = "D:/hongyu/academic/cs171-assignment5-xyi1023/Coding/res/shader/cloth.vs";
        auto fragmentShader = "D:/hongyu/academic/cs171-assignment5-xyi1023/Coding/res/shader/cloth.fs";
        const float timeStep = 0.002f;

        // Cloth settings
        unsigned int nWidth = 50;
        ...
        // create sphere
        Sphere sphere(glm::vec3(0.0f, -1.0f, 0.0f), 1.0f, glm::mat4(1.0f));
